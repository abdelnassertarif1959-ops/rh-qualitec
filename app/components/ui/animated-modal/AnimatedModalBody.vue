    ...
    <AnimatePresence>
      ...
      >
        ...
        <Motion
          ...
          aria-modal="true"
          tabindex="-1"
          class="relative z-50 flex max-h-[85vh] w-[min(720px,calc(100vw-32px))] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl"
          :class="[props.class]"
          :initial="{
            opacity: 0,
            scale: 0.5,
        ...
        >
          ...
          >
            <svg
              ...
              class="h-4 w-4 text-gray-600 transition duration-200 group-hover:scale-125 group-hover:rotate-3 group-hover:text-gray-900"
            >
