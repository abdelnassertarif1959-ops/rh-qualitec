        ...
        <div class="divide-y divide-gray-50">
          ...
          >
            ...
            <div class="flex items-center gap-1 flex-shrink-0">
              <button type="button" class="p-1.5 text-purple-600 hover:bg-purple-100 rounded-lg transition-colors" title="Visualizar" @click="visualizar(doc)">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const visualizar = (doc: Documento) => {
  window.open(`/api/funcionarios/documentos/${doc.id}/view`, '_blank')
}
